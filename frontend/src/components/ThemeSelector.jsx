...
const ThemeSelector = () => {
  ...
  return (
    ...
    //     <div className="dropdown-content mt-2 p-1 shadow-2xl bg-base-200 backdrop-blur-lg rounded-2xl w-56 border border-base-content/10 max-h-80 overflow-y-auto" tabIndex={0}></div>
    ...
    //         <div className="ml-auto flex gap-1"> {themeOption.colors.map((color, i) => (
  ...
  <div className="dropdown-content mt-2 p-1 shadow-2xl bg-base-200 backdrop-blur-lg rounded-2xl w-56 border border-base-content/10 max-h-80 overflow-y-auto space-y-1">
    {THEMES.map((themeOption) => (
      <button
